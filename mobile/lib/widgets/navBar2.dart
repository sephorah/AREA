...
class CustomNavBar2 extends StatefulWidget implements PreferredSizeWidget {
  ...
  const CustomNavBar2({super.key, required this.translationManager, required this.onSwitchLanguage})
    : preferredSize = const Size.fromHeight(90.0);
  
  @override
  CustomNavBar2State createState() => CustomNavBar2State();
  
}

class CustomNavBar2State extends State<CustomNavBar2> {
    ...
    return AppBar(
      ...
      actions: [
        ...
        Padding(
          padding: const EdgeInsets.only(right: 10.0),
          child: Tooltip(
            message: widget.translationManager.getText("customNavBar", "homeTooltip"),
            child: IconButton(
              onPressed: () {
                          ...
                          return Column(
                            ...
                            children: <Widget>[
                              ...
                              ListTile(
                                ...
                                title: Text(
                                  widget.translationManager.getText("customNavBar", "homeTooltip"), 
                                  style: const TextStyle(
                                    color: Colors.black,
                                    fontFamily: 'Murecho',
                                    fontSize: 20,
